...
return (
    <Link to={`/item/${id}`}>
        <div className="cursor-pointer relative max-w-sm rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
